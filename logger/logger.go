...
// 新建日志打印器
func New(option LogOption) *CustLogger {
	wd, _ := os.Getwd()
	...
	if CustLogger.flag|LAsync != 0 {
		go CustLogger.receive()
	}
	return CustLogger
}

func (l *CustLogger) receive() {
	today := time.Now()
	var file *os.File
	var err error
	for data := range l.in {
...
// 压缩
func (l *CustLogger) rotate(t time.Time) {
...
func (l *CustLogger) Output(lvl int, calldepth int, content string) error {
...
// 整理日志header
func (l *CustLogger) formatHeader(buf *[]byte, lvl int, t time.Time, file string, line int) {
	if l.flag&LUTC != 0 {
		t = t.UTC()
	}
...
// print
func (l *CustLogger) Printf(format string, v ...interface{}) {
	l.Output(Linfo, 2, fmt.Sprintf(format, v...))
}

func (l *CustLogger) Print(v ...interface{}) {
	l.Output(Linfo, 2, fmt.Sprintf(smartFormat(v...), v...))
}

// debug
func (l *CustLogger) Debugf(format string, v ...interface{}) {
	if Ldebug&l.flag != 0 {
		l.Output(Ldebug, 2, fmt.Sprintf(format, v...))
	}
}

func (l *CustLogger) Debug(v ...interface{}) {
	if Ldebug&l.flag != 0 {
...
// info
func (l *CustLogger) Infof(format string, v ...interface{}) {
	if Linfo&l.flag != 0 {
		l.Output(Linfo, 2, fmt.Sprintf(format, v...))
	}
}

func (l *CustLogger) Info(v ...interface{}) {
	if Linfo&l.flag != 0 {
		l.Output(Linfo, 2, fmt.Sprintf(smartFormat(v...), v...))
	}
}
...
// warn
func (l *CustLogger) Warnf(format string, v ...interface{}) {
	if Lwarn&l.flag != 0 {
		l.Output(Lwarn, 2, fmt.Sprintf(format, v...))
	}
}

func (l *CustLogger) Warn(v ...interface{}) {
	if Lwarn&l.flag != 0 {
...
// error
func (l *CustLogger) Errorf(format string, v ...interface{}) {
	if Lerror&l.flag != 0 {
		l.Output(Lerror, 2, fmt.Sprintf(format, v...)+CallerStack())
	}
}

func (l *CustLogger) Error(v ...interface{}) {
	if Lerror&l.flag != 0 {
...
// fatal
func (l *CustLogger) Fatalf(format string, v ...interface{}) {
	l.Output(Lfatal, 2, fmt.Sprintf(format, v...))
	os.Exit(1)
}

func (l *CustLogger) Fatal(v ...interface{}) {
	l.Output(Lfatal, 2, fmt.Sprintf(smartFormat(v...), v...))
	os.Exit(1)
}

func (l *CustLogger) Breakpoint() {
	l.Output(Ldebug, 3, fmt.Sprintln("breakpoint"))
}

// 设置日志目录
func (l *CustLogger) SetLogDir(dir string) {
	l.mu.Lock()
	defer l.mu.Unlock()
	l.dir = dir
}
...
// 设置日志对象名称
func (l *CustLogger) SetObj(obj string) {
	l.mu.Lock()
	defer l.mu.Unlock()
	l.obj = obj
}
...
// 改变日志输出writer
func (l *CustLogger) SetOutput(out io.Writer) {
	l.mu.Lock()
	defer l.mu.Unlock()
	l.out = out
}
...
// 设置日志等级
func (l *CustLogger) SetLevel(lvl int) {
	l.mu.Lock()
	defer l.mu.Unlock()
	var i uint
...
func init() {
	...
	f, _ := os.OpenFile(fileName, os.O_CREATE|os.O_APPEND|os.O_WRONLY, 0666)
	log := New(LogOption{
		Out:        f,
		Flag:       LstdFlags,
		LogDir:     "",
